...
## Bug #XX
**Симптом:** Тестовые команды отдельных тасок реализуют только публикацию тасок, но остальная логика не работает. Реализовать полную логику тестовых команд для отдельных тасок. Чтобы по вызову команды начиналась игра с нужной таски и работала вся логика и далее таски публиковались по порядку с указанной до конца игры.
